...
import { bgAnimation, modalAnimation } from "../animations/ModalManagar.animations";
...
const ModalManager = () => {
    ...
    return (
        <Portal>
            <motion.div
            className="z-40 flex min-h-full w-full items-center justify-center bg-black/80" onClick={()=> setModal({modal:<></>, opened: false})}
